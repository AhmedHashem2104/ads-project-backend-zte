  ...
  <section id="mu-slider">
    ...
    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display:flex;align-items:center;height:500px;">
          ...
          <img src="/public/uploads/<?php echo e($slider['img']); ?>" style="width: 50%;height:70%;margin-right:5px;" alt="img">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <span><img src="/public/uploads/<?php echo e($category['img']); ?>" style="width:100px;height:100px;"></span>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-right">
                    ...
                    <img src="/public/uploads/<?php echo e($about['img']); ?>" style="width:100%;" class="col-lg-12" alt="img">
     ...
     <div class="col-lg-6 col-md-6 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a target="_blank" href="<?php echo e($feature['link']); ?>"><img src="/public/uploads/<?php echo e($feature['img']); ?>" alt="img"></a>
                  </figure>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
         ...
         <?php $__currentLoopData = $abouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <img style="width: 100%;height:auto;" src="/public/uploads/<?php echo e($abo['img']); ?>" alt="img">
                  </figure>
                  <div class="mu-latest-course-single-content">
                ...
                <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="/public/uploads/<?php echo e($team['img']); ?>" alt="teacher img">
            ...
            <div id="mu-testimonial-slide" class="mu-testimonial-content">
              ...
              <div class="mu-testimonial-item">
                <div class="mu-testimonial-quote">
                  <blockquote>
                    <p><?php echo e($client['comment']); ?></p>
                  </blockquote>
                </div>
                <div class="mu-testimonial-img">
                  <img src="/public/uploads/<?php echo e($client['img']); ?>" alt="img">
                </div>
                ...
                <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                     <img style="width: 100%;" src="/public/uploads/<?php echo e($partner['logo']); ?>" alt="img">
                    </figure>
                  </article>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Qodeex ZTE PHP\views/index.blade.php ENDPATH**/ ?>