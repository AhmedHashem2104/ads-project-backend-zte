      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="<?php echo e($lang == 'en' ? '/en' : '/ar'); ?>/home"><?php echo e($lang == 'en' ? 'Home' : 'الرئيسية'); ?></a></li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                  <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <li><a href="<?php echo e($lang == 'en' ? '/en' : '/ar'); ?>/service/<?php echo e(json_decode($experience['page'])->$lang); ?>"><img src="/public/<?php echo e($experience['icon']); ?>" style="width:30px;"> <?php echo e(json_decode($experience['title'])->$lang); ?></a></li>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </li>
            <li><a href="<?php echo e($lang == 'en' ? '/en/blogs' : '/ar/blogs'); ?>"><?php echo e($lang == 'en' ? 'Blogs' : 'المقالات'); ?></a></li>
            <li><a href="<?php echo e($lang == 'en' ? '/en/contact-us' : '/ar/contact-us'); ?>"><?php echo e($lang == 'en' ? 'Contact Us' : 'تواصل معنا'); ?></a></li>
            <?php if($lang == 'en'): ?>
                <li><a href="/ar/home">عربى</a></li>
            <?php elseif($lang == 'ar'): ?>
        ...
        <div class="mu-footer-bottom">
            <div class="container">
                <div class="mu-footer-bottom-area">
                    <p style="font-size:18px;">&copy;<?php echo e($lang == 'en' ? ' All Right Reserved. Designed & Developed by ' : ' كل الحقوق محفوظة. صمم وطور بواسطة  '); ?><a href="http://www.qodeex.com/home" target="_blank" rel="nofollow" style="color: #ff5733;"><?php echo e($lang == 'en' ? 'Qodeex for software and training' : 'كودكس للبرمجيات والتدريب'); ?></a></p>
                </div>
            </div>
        </div>
        <!-- end footer bottom -->
...
</html><?php /**PATH C:\Users\Ahmed\Desktop\qodeex-zte\views/layouts/app.blade.php ENDPATH**/ ?>