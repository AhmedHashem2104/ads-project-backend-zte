      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="{{$lang == 'en' ? '/en' : '/ar'}}/home">{{$lang == 'en' ? 'Home' : 'الرئيسية'}}</a></li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                  @foreach ($experiences as $experience)
                   <li><a href="{{$lang == 'en' ? '/en' : '/ar'}}/service/{{json_decode($experience['page'])->$lang}}"><img src="/public/{{$experience['icon']}}" style="width:30px;"> {{json_decode($experience['title'])->$lang}}</a></li>
                  @endforeach
              </ul>
            </li>
            <li><a href="{{$lang == 'en' ? '/en/blogs' : '/ar/blogs'}}">{{$lang == 'en' ? 'Blogs' : 'المقالات'}}</a></li>
            <li><a href="{{$lang == 'en' ? '/en/contact-us' : '/ar/contact-us'}}">{{$lang == 'en' ? 'Contact Us' : 'تواصل معنا'}}</a></li>
            @if ($lang == 'en')
        ...
        <div class="mu-footer-bottom">
            <div class="container">
                <div class="mu-footer-bottom-area">
                    <p style="font-size:18px;">&copy;{{$lang == 'en' ? ' All Right Reserved. Designed & Developed by ' : ' كل الحقوق محفوظة. صمم وطور بواسطة  '}}<a href="http://www.qodeex.com/home" target="_blank" rel="nofollow" style="color: #ff5733;">{{$lang == 'en' ? 'Qodeex for software and training' : 'كودكس للبرمجيات والتدريب'}}</a></p>
                </div>
            </div>
        </div>
        <!-- end footer bottom -->
