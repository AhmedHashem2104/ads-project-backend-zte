...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="{{$info['short_description_'.$lang]}}">
    <meta name="keywords" content="{{$info['keywords_'.$lang]}}">
    <meta name="author" content="Ahmed Hashem">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>{{$lang == 'en' ? 'Home - ' :' الرئيسية - ' }}{{$info['company_name_'.$lang]}}</title>
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- LOGO -->
                    <!-- TEXT BASED LOGO -->
                    <a class="navbar-brand" href="{{$lang == 'en' ? '/en' : '/ar'}}/home"><img style="width:100px;margin-top:-5px;display:flex;" src="https://dashboard.qodeex.com/editor/imgs/company/{{$info['logo']}}"></a>
                    <!-- IMG BASED LOGO  -->
                    ...
                    <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                        ...
                        <li class="dropdown" style="{{$lang == 'ar' ? 'text-align:right;direction:rtl;font-weight:bold;' : 'font-weight:bold;'}}">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li style="{{$lang == 'ar' ? 'text-align:right;direction:rtl;font-weight:bold;' : 'font-weight:bold;'}}"><a href="{{$lang == 'en' ? '/en' : '/ar'}}/service/{{$service['service_id']}}"><img src="https://dashboard.qodeex.com/editor/imgs/services/{{$service['icon']}}" style="width:100px;"> {{$service['service_name_'.$lang]}}</a></li>
                                @endforeach
                            </ul>
                        </li>
